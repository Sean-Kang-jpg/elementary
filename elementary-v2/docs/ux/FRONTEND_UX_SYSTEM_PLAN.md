...
- [ ] P6 data pilots: follow the academy, timetable, and playground decisions and production gates in [`../operations/OPERATION_PLAN.md`](../operations/OPERATION_PLAN.md) before creating production tables.
